...
BadCastException::BadCastException(const std::type_info& from, const std::type_info& to) :
    Exception(xformat(BadCastException::tr("Failed to convert {} to {}"), humanReadableName(from), humanReadableName(to)))
{}

BadCastException::BadCastException(const QMetaType& from, const QMetaType& to):
    Exception(xformat(BadCastException::tr("Failed to convert {} to {}"), QLatin1String(from.name()), QLatin1String(to.name())))
{}
