...
constexpr std::array<KeyMappingElement, 256> KeyMapping = {{
    ...
    {Qt::Key_Clear,         Qt::KeypadModifier},    //  12   0x0C   VK_CLEAR            | Clear key                     | Numpad '5' (without Num Lock)
    ...
    {Qt::Key_Minus,         Qt::KeypadModifier},    // 109   0x6D   VK_SUBTRACT         | Subtract key                  | Numpad
    {Qt::Key_Period,        Qt::KeypadModifier},    // 110   0x6E   VK_DECIMAL          | Decimal key (locale-dependent) | Numpad (with Num Lock)
    {Qt::Key_Slash,         Qt::KeypadModifier},    // 111   0x6F   VK_DIVIDE           | Divide key                    | Numpad
