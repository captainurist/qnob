...
constexpr std::array<KeyMappingElement, 256> KeyMapping = {{
    ...
    {Qt::Key_unknown,       0},                     //   1   0x01   VK_LBUTTON          | Left mouse button
    {Qt::Key_unknown,       0},                     //   2   0x02   VK_RBUTTON          | Right mouse button
    {Qt::Key_Cancel,        0},                     //   3   0x03   VK_CANCEL           | Control-Break processing
    {Qt::Key_unknown,       0},                     //   4   0x04   VK_MBUTTON          | Middle mouse button
    {Qt::Key_unknown,       0},                     //   5   0x05   VK_XBUTTON1         | X1 mouse button
    {Qt::Key_unknown,       0},                     //   6   0x06   VK_XBUTTON2         | X2 mouse button
    {Qt::Key_unknown,       0},                     //   7   0x07   -- unassigned --
    {Qt::Key_Backspace,     0},                     //   8   0x08   VK_BACK             | BackSpace key
    {Qt::Key_Tab,           0},                     //   9   0x09   VK_TAB              | Tab key
    {Qt::Key_unknown,       0},                     //  10   0x0A   -- reserved --
    {Qt::Key_unknown,       0},                     //  11   0x0B   -- reserved --
    {Qt::Key_Clear,         0},                     //  12   0x0C   VK_CLEAR            | Clear key
    {Qt::Key_Return,        0},                     //  13   0x0D   VK_RETURN           | Enter key
    {Qt::Key_unknown,       0},                     //  14   0x0E   -- unassigned --
    ...
    {Qt::Key_unknown,       0},                     //  21   0x15   VK_KANA / VK_HANGUL | IME Kana or Hangul mode
    {Qt::Key_unknown,       0},                     //  22   0x16   -- unassigned --
    {Qt::Key_unknown,       0},                     //  23   0x17   VK_JUNJA            | IME Junja mode
    {Qt::Key_unknown,       0},                     //  24   0x18   VK_FINAL            | IME final mode
    {Qt::Key_unknown,       0},                     //  25   0x19   VK_HANJA / VK_KANJI | IME Hanja or Kanji mode
    {Qt::Key_unknown,       0},                     //  26   0x1A   -- unassigned --
    {Qt::Key_Escape,        0},                     //  27   0x1B   VK_ESCAPE           | Esc key
    {Qt::Key_unknown,       0},                     //  28   0x1C   VK_CONVERT          | IME convert
    {Qt::Key_unknown,       0},                     //  29   0x1D   VK_NONCONVERT       | IME non-convert
    {Qt::Key_unknown,       0},                     //  30   0x1E   VK_ACCEPT           | IME accept
    {Qt::Key_Mode_switch,   0},                     //  31   0x1F   VK_MODECHANGE       | IME mode change request
    ...
    {Qt::Key_Select,        0},                     //  41   0x29   VK_SELECT           | Select key
    {Qt::Key_Printer,       0},                     //  42   0x2A   VK_PRINT            | Print key
    {Qt::Key_Execute,       0},                     //  43   0x2B   VK_EXECUTE          | Execute key
    ...
    {Qt::Key_Help,          0},                     //  47   0x2F   VK_HELP             | Help key
    ...
    {Qt::Key_unknown,       0},                     //  58   0x3A   -- unassigned --
    {Qt::Key_unknown,       0},                     //  59   0x3B   -- unassigned --
    {Qt::Key_unknown,       0},                     //  60   0x3C   -- unassigned --
    {Qt::Key_unknown,       0},                     //  61   0x3D   -- unassigned --
    {Qt::Key_unknown,       0},                     //  62   0x3E   -- unassigned --
    {Qt::Key_unknown,       0},                     //  63   0x3F   -- unassigned --
    {Qt::Key_unknown,       0},                     //  64   0x40   -- unassigned --
    ...
    {Qt::Key_Menu,          0},                     //  93   0x5D   VK_APPS             | Application key-MS Natural kbd
    {Qt::Key_unknown,       0},                     //  94   0x5E   -- reserved --
    {Qt::Key_Sleep,         0},                     //  95   0x5F   VK_SLEEP
    ...
    {Qt::Key_Asterisk,      0},                     // 106   0x6A   VK_MULTIPLY         | Multiply key
    {Qt::Key_Plus,          0},                     // 107   0x6B   VK_ADD              | Add key
    {Qt::Key_unknown,       0},                     // 108   0x6C   VK_SEPARATOR        | Separator key (locale-dependent)
    {Qt::Key_Minus,         0},                     // 109   0x6D   VK_SUBTRACT         | Subtract key
    {Qt::Key_unknown,       0},                     // 110   0x6E   VK_DECIMAL          | Decimal key (locale-dependent)
    {Qt::Key_Slash,         0},                     // 111   0x6F   VK_DIVIDE           | Divide key
    ...
    {Qt::Key_unknown,       0},                     // 136   0x88   -- unassigned --
    {Qt::Key_unknown,       0},                     // 137   0x89   -- unassigned --
    {Qt::Key_unknown,       0},                     // 138   0x8A   -- unassigned --
    {Qt::Key_unknown,       0},                     // 139   0x8B   -- unassigned --
    {Qt::Key_unknown,       0},                     // 140   0x8C   -- unassigned --
    {Qt::Key_unknown,       0},                     // 141   0x8D   -- unassigned --
    {Qt::Key_unknown,       0},                     // 142   0x8E   -- unassigned --
    {Qt::Key_unknown,       0},                     // 143   0x8F   -- unassigned --
    {Qt::Key_NumLock,       0},                     // 144   0x90   VK_NUMLOCK          | Num Lock key
    {Qt::Key_ScrollLock,    0},                     // 145   0x91   VK_SCROLL           | Scroll Lock key
                                                    // Fujitsu/OASYS kbd --------------------
    {Qt::Key_unimplemented, 0},                     // 146   0x92   VK_OEM_FJ_JISHO     | 'Dictionary' key /
    ...
    {Qt::Key_unimplemented, 0},                     // 149   0x95  VK_OEM_FJ_LOYA  | 'Left OYAYUBI' key
    {Qt::Key_unimplemented, 0},                     // 150  0x96  VK_OEM_FJ_ROYA  | 'Right OYAYUBI' key
    {Qt::Key_unknown,       0},                     // 151   0x97   -- unassigned --
    {Qt::Key_unknown,       0},                     // 152   0x98   -- unassigned --
    {Qt::Key_unknown,       0},                     // 153   0x99   -- unassigned --
    {Qt::Key_unknown,       0},                     // 154   0x9A   -- unassigned --
    {Qt::Key_unknown,       0},                     // 155   0x9B   -- unassigned --
    {Qt::Key_unknown,       0},                     // 156   0x9C   -- unassigned --
    {Qt::Key_unknown,       0},                     // 157   0x9D   -- unassigned --
    {Qt::Key_unknown,       0},                     // 158   0x9E   -- unassigned --
    {Qt::Key_unknown,       0},                     // 159   0x9F   -- unassigned --
    ...
    {Qt::Key_Back,          0},                     // 166   0xA6   VK_BROWSER_BACK     | Browser Back key
    ...
    {Qt::Key_unknown,       0},                     // 184   0xB8   -- reserved --
    {Qt::Key_unknown,       0},                     // 185   0xB9   -- reserved --
    {Qt::Key_unimplemented, 0},                     // 186   0xBA   VK_OEM_1            | ';:' for US
    {Qt::Key_Plus,          Qt::KeypadModifier},    // 187   0xBB   VK_OEM_PLUS         | '+' any country
    {Qt::Key_Comma,         Qt::KeypadModifier},    // 188   0xBC   VK_OEM_COMMA        | ',' any country
    {Qt::Key_Minus,         Qt::KeypadModifier},    // 189   0xBD   VK_OEM_MINUS        | '-' any country
    {Qt::Key_Period,        Qt::KeypadModifier},    // 190   0xBE   VK_OEM_PERIOD       | '.' any country
    {Qt::Key_unimplemented, Qt::KeypadModifier},    // 191   0xBF   VK_OEM_2            | '/?' for US
    {Qt::Key_unimplemented, Qt::KeypadModifier},    // 192   0xC0   VK_OEM_3            | '`~' for US
    {Qt::Key_unknown,       0},                     // 193   0xC1   -- reserved --
    {Qt::Key_unknown,       0},                     // 194   0xC2   -- reserved --
    {Qt::Key_unknown,       0},                     // 195   0xC3   -- reserved --
    {Qt::Key_unknown,       0},                     // 196   0xC4   -- reserved --
    {Qt::Key_unknown,       0},                     // 197   0xC5   -- reserved --
    {Qt::Key_unknown,       0},                     // 198   0xC6   -- reserved --
    {Qt::Key_unknown,       0},                     // 199   0xC7   -- reserved --
    {Qt::Key_unknown,       0},                     // 200   0xC8   -- reserved --
    {Qt::Key_unknown,       0},                     // 201   0xC9   -- reserved --
    {Qt::Key_unknown,       0},                     // 202   0xCA   -- reserved --
    {Qt::Key_unknown,       0},                     // 203   0xCB   -- reserved --
    {Qt::Key_unknown,       0},                     // 204   0xCC   -- reserved --
    {Qt::Key_unknown,       0},                     // 205   0xCD   -- reserved --
    {Qt::Key_unknown,       0},                     // 206   0xCE   -- reserved --
    {Qt::Key_unknown,       0},                     // 207   0xCF   -- reserved --
    {Qt::Key_unknown,       0},                     // 208   0xD0   -- reserved --
    {Qt::Key_unknown,       0},                     // 209   0xD1   -- reserved --
    {Qt::Key_unknown,       0},                     // 210   0xD2   -- reserved --
    {Qt::Key_unknown,       0},                     // 211   0xD3   -- reserved --
    {Qt::Key_unknown,       0},                     // 212   0xD4   -- reserved --
    {Qt::Key_unknown,       0},                     // 213   0xD5   -- reserved --
    {Qt::Key_unknown,       0},                     // 214   0xD6   -- reserved --
    {Qt::Key_unknown,       0},                     // 215   0xD7   -- reserved --
    {Qt::Key_unknown,       0},                     // 216   0xD8   -- unassigned --
    {Qt::Key_unknown,       0},                     // 217   0xD9   -- unassigned --
    {Qt::Key_unknown,       0},                     // 218   0xDA   -- unassigned --
    {Qt::Key_unimplemented, 0},                     // 219   0xDB   VK_OEM_4            | '[{' for US
    {Qt::Key_unimplemented, 0},                     // 220   0xDC   VK_OEM_5            | '\|' for US
    {Qt::Key_unimplemented, 0},                     // 221   0xDD   VK_OEM_6            | ']}' for US
    {Qt::Key_unimplemented, 0},                     // 222   0xDE   VK_OEM_7            | ''"' for US
    {Qt::Key_unimplemented, 0},                     // 223   0xDF   VK_OEM_8
    {Qt::Key_unknown,       0},                     // 224   0xE0   -- reserved --
    {Qt::Key_unknown,       0},                     // 225   0xE1   VK_OEM_AX           | 'AX' key on Japanese AX kbd
    {Qt::Key_unknown,       0},                     // 226   0xE2   VK_OEM_102          | "<>" or "\|" on RT 102-key kbd
    {Qt::Key_unknown,       0},                     // 227   0xE3   VK_ICO_HELP         | Help key on ICO
    {Qt::Key_unknown,       0},                     // 228   0xE4   VK_ICO_00           | 00 key on ICO
    {Qt::Key_unknown,       0},                     // 229   0xE5   VK_PROCESSKEY       | IME Process key
    {Qt::Key_unknown,       0},                     // 230   0xE6   VK_ICO_CLEAR        |
    {Qt::Key_unknown,       0},                     // 231   0xE7   VK_PACKET           | Unicode char as keystrokes
    {Qt::Key_unknown,       0},                     // 232   0xE8   -- unassigned --
                                                    // Nokia/Ericsson definitions ---------------
    {Qt::Key_unknown,       0},                     // 233   0xE9   VK_OEM_RESET
    {Qt::Key_unknown,       0},                     // 234   0xEA   VK_OEM_JUMP
    {Qt::Key_unknown,       0},                     // 235   0xEB   VK_OEM_PA1
    {Qt::Key_unknown,       0},                     // 236   0xEC   VK_OEM_PA2
    {Qt::Key_unknown,       0},                     // 237   0xED   VK_OEM_PA3
    {Qt::Key_unknown,       0},                     // 238   0xEE   VK_OEM_WSCTRL
    {Qt::Key_unknown,       0},                     // 239   0xEF   VK_OEM_CUSEL
    {Qt::Key_unknown,       0},                     // 240   0xF0   VK_OEM_ATTN
    {Qt::Key_unknown,       0},                     // 241   0xF1   VK_OEM_FINISH
    {Qt::Key_unknown,       0},                     // 242   0xF2   VK_OEM_COPY
    {Qt::Key_unknown,       0},                     // 243   0xF3   VK_OEM_AUTO
    {Qt::Key_unknown,       0},                     // 244   0xF4   VK_OEM_ENLW
    {Qt::Key_unknown,       0},                     // 245   0xF5   VK_OEM_BACKTAB
    {Qt::Key_unknown,       0},                     // 246   0xF6   VK_ATTN             | Attn key
    {Qt::Key_unknown,       0},                     // 247   0xF7   VK_CRSEL            | CrSel key
    {Qt::Key_unknown,       0},                     // 248   0xF8   VK_EXSEL            | ExSel key
    {Qt::Key_unknown,       0},                     // 249   0xF9   VK_EREOF            | Erase EOF key
    {Qt::Key_Play,          0},                     // 250   0xFA   VK_PLAY             | Play key
    {Qt::Key_Zoom,          0},                     // 251   0xFB   VK_ZOOM             | Zoom key
    {Qt::Key_unknown,       0},                     // 252   0xFC   VK_NONAME           | Reserved
    {Qt::Key_unknown,       0},                     // 253   0xFD   VK_PA1              | PA1 key
    {Qt::Key_unimplemented, 0},                     // 254   0xFE   VK_OEM_CLEAR        | Clear key
    {Qt::Key_unimplemented, 0}
}};


class WinShortcutEventHandler : public QWindow {
public:
    WinShortcutEventHandler(WinShortcutDispatcher* dispatcher) : m_dispatcher(dispatcher) {}

    virtual bool nativeEvent(const QByteArray& eventType, void* message, qintptr* result) override {
        MSG* msg = static_cast<MSG*>(message);
        if (msg->message == WM_HOTKEY)
            m_dispatcher->dispatchEvent(message);
...
WinShortcutDispatcher::WinShortcutDispatcher(QObject* parent): QObject(parent) {
    for (quint32 winKey = 0; winKey < KeyMapping.size(); winKey++) {
        ...
        quint32 combinedKey = (qtKey | KeyMapping[winKey].mods).toCombined();

        assert(!m_winKeyByQtKey.contains(combinedKey));
        m_winKeyByQtKey[combinedKey] = winKey;
    }

    m_eventHandler.reset(new WinShortcutEventHandler(this));
}
